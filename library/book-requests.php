...
<head>
    ...
    <title>Online Library Management System | My Book Requests</title>
...
<?php include('includes/header.php');?>
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">My Book Requests</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
<?php
$sql="SELECT tblbookrequests.id,tblbookrequests.RequestDate,tblbookrequests.Status,tblbookrequests.AdminRemark,tblbookrequests.ActionDate,
...
WHERE tblbookrequests.StudentId=:sid
ORDER BY tblbookrequests.id DESC";
...
?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo htmlentities($result->AdminRemark!=""?$result->AdminRemark:"Pending admin action");?></td>
