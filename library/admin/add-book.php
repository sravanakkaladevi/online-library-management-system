...
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage,bookQty,PreviewLink) VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:bqty,:previewlink)";
