...
$bqty=$_POST['bqty'];
$previewlink=trim($_POST['previewlink']);
$sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,BookPrice=:price,bookQty=:bqty,PreviewLink=:previewlink where id=:bookid";
...
$query->bindParam(':previewlink',$previewlink,PDO::PARAM_STR);
$query->execute();
